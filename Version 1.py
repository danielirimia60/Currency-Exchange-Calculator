...
while end != "n":
    ...
    if answer == 'y':
        ...
        print("The amount you will receive is of " + str(exchangeCurrency) + str(finalAmount) + " at a conversion rate of " + str(newConversionRate) + " .")
    elif answer == 'n':
        finalAmount = initialAmount * finalOption
        print("The amount you will receive is of " + str(exchangeCurrency) + str(finalAmount) + " at a conversion rate of " + str(finalOption) + " .")
